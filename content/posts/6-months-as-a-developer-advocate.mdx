---
title: Six Months as a Developer Advocate
date: '2021-05-23'
categories: ['DevRel']
...
<Callout
  variant="info"
  content="In this article I share my own story of how I got into Develeoper Relations. I'm using this article to document my journey. Absorb what is useful, discard what is not."
/>
...
![Joining Egghead announcement](/images/writing/6-months-as-a-developer-advocate/join-egghead.png)
...
![Job position tweet](/images/writing/6-months-as-a-developer-advocate/prisma-job-listing.png)
...
![Meme where genie says there are three rules, no falling in love, no wishing for death and no bringing back dead people. I wish for knowinghow to estimate a task and genie says there are 4 rules](/images/writing/6-months-as-a-developer-advocate/estimates-meme.png)
...
- Published an article about [React Server Components](https://www.prisma.io/writing/database-access-in-react-server-components-r2xgk9aztgdf) on the Prisma writing. ⚛
- Went on a [Livestream with Colby Fayock](https://www.youtube.com/watch?v=5UZBhWAlyTo) where I built a Next.js X Prisma demo.
- Created the [What is Prisma](https://www.youtube.com/watch?v=EEDGwLB55bI) video because [Prisma is now Production-ready](https://www.prisma.io/writing/prisma-the-complete-orm-inw24qjeawmb) ✨
